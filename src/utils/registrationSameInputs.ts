export default function copyBillingToShipping() {
    ...
    const BILLING_INPUT_STREET: HTMLInputElement = document.getElementById('billingStreet') as HTMLInputElement;
    ...
    const BILLING_INPUT_CITY: HTMLInputElement = document.getElementById('billingCity') as HTMLInputElement;
    ...
    const BILLING_INPUT_POSTAL_CODE: HTMLInputElement = document.getElementById('billingPostalCode') as HTMLInputElement;
    if (SHIPPING_INPUT_POSTAL_CODE && BILLING_INPUT_POSTAL_CODE) {
        SHIPPING_INPUT_POSTAL_CODE.value = BILLING_INPUT_POSTAL_CODE.value;
    }
    const SHIPPING_INPUT_COUNTRY: HTMLInputElement = document.getElementById('shippingCountry') as HTMLInputElement;
    const BILLING_INPUT_COUNTRY: HTMLInputElement = document.getElementById('billingCountry') as HTMLInputElement;
